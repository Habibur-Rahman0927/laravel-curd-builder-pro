...
<head>
    ...
    <meta name="description" content="Register to the Laravel CRUD Builder - the ultimate tool for automated CRUD operations with flexible customization options.">
    <meta name="keywords" content="Laravel, CRUD, Builder, Register, Authentication, Admin, Automated, Database">
...
<body>
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="name" class="form-control" type="text" name="name" placeholder="Full Name" value="{{ old('name') }}" required autofocus>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input id="email" class="form-control" type="email" name="email" placeholder="Email" value="{{ old('email') }}" required autocomplete="email">
                    @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-between mt-3">
                    <a class="text-decoration-none" href="{{ route('login') }}">Already have an account? Log in</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        const mouseRadius = 200; // Cursor interaction radius
        ...
        class Node {
            ...
            move() {
                ...
                if (distance < mouseRadius && distance > 0) {
                    ...
                    this.x -= Math.cos(angle) * moveFactor * 2; // Move slightly away
        ...
        function drawLines() {
            for (let i = 0; i < totalNodes; i++) {
                ...
                // Line from node to cursor if near
