...
@section('title', __('{{ name }}_module.create_list_edit.edit_page_title'))
...
<div class="content">
    <div class="row">
        <div class="col-md-12 page-header mb-2">
            ...
            <h1 class="page-title">{{ __('{{ name }}_module.create_list_edit.edit_page_title') }}</h1>
        </div>
    </div>
    <div class="row">
        <div class="card shadow w-100">
            <div class="card-body">
                ...
                <form class="" method="POST" action="{{ route('{{ name }}.update', $data->id) }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12 text-end"> 
                            <a href="{{ route('{{ name }}.index') }}" class="btn btn-secondary me-2">{{ __('standard_curd_common_label.back') }}</a>
                            <button type="submit" class="btn btn-primary">{{ __('standard_curd_common_label.update') }}</button>
                        </div>
                    </div>
                </form>
            </div>
